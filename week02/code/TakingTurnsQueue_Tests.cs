...
public class TakingTurnsQueueTests
{
    ...
    [TestMethod]
    // Scenario: Create a queue with Bob (2), Tim (5), Sue (3). 
    // After running 5 times, add George with 3 turns. 
    ...
    [TestMethod]
    // Scenario: Create a queue with Bob (2), Tim (Forever), Sue (3).
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: None.
    public void TestTakingTurnsQueue_ForeverZero()
    {
        ...
        // Verify that the person with infinite turns does not change.
    ...
    [TestMethod]
    // Scenario: Create a queue with Tim (Forever), Sue (3).
    // Run 10 times.
